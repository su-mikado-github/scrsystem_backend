...
class EmptyState extends Model {
    use HasFactory;

    public static function rebuild($date, $start_time, $end_time) {
        return DB::statement('CALL rebuild_empty_states(?,?,?)', [ $date, $start_time, $end_time ]);
    }
