...
Route::middleware([ 'attest' ])->group(function() {
    ...
    Route::prefix('/reserve')->group(function() {
        ...
        Route::prefix('/change')->group(function() {
            ...
            Route::get('/{date}/visit', [ App\Http\Controllers\Reserve\ChangeController::class, 'visit' ])->name('reserve.change.visit')->where('date', '^[0-9]{4}-[0-9]{2}-[0-9]{2}');
            Route::get('/{date}/lanchbox', [ App\Http\Controllers\Reserve\ChangeController::class, 'lunchbox' ])->name('reserve.change.lunchbox')->where('date', '^[0-9]{4}-[0-9]{2}-[0-9]{2}');
            Route::get('/{reserve_id}/reserve', [ App\Http\Controllers\Reserve\ChangeController::class, 'reserve' ])->name('reserve.change.reserve')->where('reserve_id', '^[0-9]+$');
